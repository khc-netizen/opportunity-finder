...
// Deployment identity for the production entrypoint.
const RELEASE = '3.9.15';
const RELEASE_BUILD = 'v3.9.15-seed-diagnostics';
const RELEASE_FINGERPRINT = 'seed-diagnostics-2026-09-10';
...
async function diagnosticHealth(request, env, ctx) {
  ...
  const diagnostic = addRelease({
    ...
    discoveryHealth: {
      ...
      recovery,
      error: health.organicResults === 0
        ? 'No organic organizations were discovered independently of the diagnostic seed set.'
        : null
    }
  });
